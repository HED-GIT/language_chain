...
$(LIB_DIR)/libada_call.so $(HEADER_DIR)/ada_call.h: $(CALL_DIR)/ada/ada_call.adb $(CALL_DIR)/ada/ada_call.ads $(CALL_DIR)/ada/ada_call.h | directories
...
$(LIB_DIR)/libc_call.so $(HEADER_DIR)/c_call.h: $(CALL_DIR)/c/c_call.c $(CALL_DIR)/c/c_call.h | directories
...
$(LIB_DIR)/libcpp_call.so $(HEADER_DIR)/cpp_call.h: $(CALL_DIR)/c++/cpp_call.cpp $(CALL_DIR)/c++/cpp_call.hpp	| directories
...
$(LIB_DIR)/libfortran_call.so $(HEADER_DIR)/fortran_call.h: $(CALL_DIR)/fortran/fortran_call.f90 $(CALL_DIR)/fortran/fortran_call.h | directories
...
$(LIB_DIR)/libgo_call.so $(HEADER_DIR)/go_call.h: $(CALL_DIR)/go/go_call.go | directories
	go build -o $(LIB_DIR)/libgo_call.so -buildmode=c-shared $(CALL_DIR)/go/go_call.go
	mv $(LIB_DIR)/libgo_call.h $(HEADER_DIR)/go_call.h

$(LIB_DIR)/libhaskell_call.so $(HEADER_DIR)/haskell_call.h: $(CALL_DIR)/haskell/haskell_call.hs | directories
...
$(LIB_DIR)/libjava_call.so $(LIB_DIR)/libr_java_call.so $(HEADER_DIR)/java_call.h $(HEADER_DIR)/r_java_call.h: $(CALL_DIR)/java/r_java_call.java $(CALL_DIR)/java/java_call.c $(CALL_DIR)/java/java_call.h | directories
...
$(LIB_DIR)/libkotlin_call.so $(HEADER_DIR)/kotlin_call.h $(LIB_DIR)/libr_kotlin_call.so $(HEADER_DIR)/r_kotlin_call.h: $(CALL_DIR)/kotlin/r_kotlin_call.kt $(CALL_DIR)/kotlin/kotlin_call.c $(CALL_DIR)/kotlin/kotlin_call.h | directories
...
$(LIB_DIR)/libnim_call.so $(HEADER_DIR)/nim_call.h: $(CALL_DIR)/nim/nim_call.nim | directories
...
$(LIB_DIR)/liboc_call.so $(HEADER_DIR)/oc_call.h: $(CALL_DIR)/objective-c/oc_call.m $(CALL_DIR)/objective-c/oc_call.h | directories
...
$(LIB_DIR)/libodin_call.so $(HEADER_DIR)/odin_call.h: $(CALL_DIR)/odin/odin_call.odin $(CALL_DIR)/odin/odin_call.h | directories
...
$(LIB_DIR)/libpascal_call.so $(HEADER_DIR)/pascal_call.h: $(CALL_DIR)/pascal/pascal_call.pp $(CALL_DIR)/pascal/pascal_call.h | directories
...
$(LIB_DIR)/librust_call.so $(HEADER_DIR)/rust_call.h $(HEADER_DIR)/rust_call.hpp: $(CALL_DIR)/rust/rust_call.rs | directories
...
$(LIB_DIR)/libzig_call.so $(HEADER_DIR)/zig_call.h: $(CALL_DIR)/zig/zig_call.zig | directories
...
$(LIB_DIR)/libada_chain.so $(HEADER_DIR)/ada_chain.h: $(CHAIN_DIR)/ada/ada_chain.adb $(CHAIN_DIR)/ada/ada_chain.ads $(CHAIN_DIR)/ada/ada_chain.h $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libc_chain.so $(HEADER_DIR)/c_chain.h: $(CHAIN_DIR)/c/c_chain.h $(CHAIN_DIR)/c/c_chain.c $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libcpp_chain.so $(HEADER_DIR)/cpp_chain.h: $(CHAIN_DIR)/c++/cpp_chain.hpp $(CHAIN_DIR)/c++/cpp_chain.cpp $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libfortran_chain.so $(HEADER_DIR)/fortran_chain.h: $(CHAIN_DIR)/fortran/fortran_chain.f90 $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libgo_chain.so $(HEADER_DIR)/go_chain.h: $(CHAIN_DIR)/go/go_chain.go $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libhaskell_chain.so $(HEADER_DIR)/haskell_chain.h: $(CHAIN_DIR)/haskell/haskell_chain.hs $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libjava_chain.so $(LIB_DIR)/libr_java_chain.so $(HEADER_DIR)/java_chain.h $(HEADER_DIR)/r_java_chain.h: $(CHAIN_DIR)/java/r_java_chain.java $(CHAIN_DIR)/java/java_chain.c $(CHAIN_DIR)/java/java_chain.h | directories
...
$(LIB_DIR)/libkotlin_chain.so $(LIB_DIR)/libr_kotlin_chain.so $(HEADER_DIR)/kotlin_chain.h $(HEADER_DIR)/r_kotlin_chain.h: $(CHAIN_DIR)/kotlin/r_kotlin_chain.kt $(CHAIN_DIR)/kotlin/kotlin_chain.c $(CHAIN_DIR)/kotlin/kotlin_chain.h $(KOTLIN_CALL_HEADERS) | directories
...
$(LIB_DIR)/libnim_chain.so $(HEADER_DIR)/nim_chain.h: $(CHAIN_DIR)/nim/nim_chain.nim $(CALL_HEADERS) | directories
...
$(LIB_DIR)/liboc_chain.so $(HEADER_DIR)/oc_chain.h: $(CHAIN_DIR)/objective-c/oc_chain.m $(CHAIN_DIR)/objective-c/oc_chain.h $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libodin_chain.so $(HEADER_DIR)/odin_chain.h: $(CHAIN_DIR)/odin/odin_chain.odin $(CHAIN_DIR)/odin/odin_chain.h $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libpascal_chain.so $(HEADER_DIR)/pascal_chain.h: $(CHAIN_DIR)/pascal/pascal_chain.pp $(CALL_HEADERS) | directories
...
$(LIB_DIR)/librust_chain.so: $(CHAIN_DIR)/rust/rust_chain.rs $(CALL_HEADERS) $(RUST_CALL_HEADERS) | directories
	rustc --crate-type=cdylib -L $(HEADER_DIR)/ $(CHAIN_DIR)/rust/rust_chain.rs -o $(LIB_DIR)/librust_chain.so

$(HEADER_DIR)/rust_chain.h: $(CHAIN_DIR)/rust/rust_chain.rs | directories
	cbindgen --output $(HEADER_DIR)/rust_chain.h --lang c $(CHAIN_DIR)/rust/rust_chain.rs

$(LIB_DIR)/libswift_chain.so $(HEADER_DIR)/swift_chain.h: $(CHAIN_DIR)/swift/swift_chain.swift $(CALL_HEADERS) | directories
...
$(LIB_DIR)/libzig_chain.so $(HEADER_DIR)/zig_chain.h: $(CHAIN_DIR)/zig/zig_chain.zig $(CALL_HEADERS) | directories
...
$(RUST_DIR)/%.rs: $(HEADER_DIR)/%.h | directories
	bindgen $< -o $@

$(RUST_DIR)/haskell_call.rs: $(HEADER_DIR)/haskell_call.h | directories
...
$(KOTLIN_DIR)/%.klib: $(HEADER_DIR)/%.h | directories
	cinterop -header $< -pkg $* -o $@

$(KOTLIN_DIR)/haskell_call.klib: $(HEADER_DIR)/haskell_call.h | directories
	cinterop -header $< -pkg haskell_call -o $@ -compiler-options -I$(GHC_INCLUDE)

$(KOTLIN_DIR)/nim_call.klib: $(HEADER_DIR)/nim_call.h | directories
